...
Morettin, relacionados com este exemplo.
...
classificadas da menos para a maior, ou vice-versa, independente da
...
da interpretação desejada para os dados. Iniciamente obtemos a tabela de
...
os dados, incluve o menor (mínimo) seja incluído na primeira classe.
...
[script_exploratoria.R]: scripts/script_exploratoria.R
[script_resposta_exploratoria.R]: scripts/script_resposta_exploratoria.R
